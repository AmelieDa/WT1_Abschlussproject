...
function read(a)
{
    ...
    document.getElementById("result").innerHTML=html; //result mit qrcode ergebnis
	
	//XML
	var raum = htmlEntities(a);
...
{
	console.log(options);
	document.getElementById("result").innerHTML="";	//Anfangstext im result Feld
    if(stype==1)
    {
        setTimeout(captureToCanvas, 500);    
        return;
